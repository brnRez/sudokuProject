package projetosudoku.computationlogic;

import projetosudoku.constants.GameState;
import projetosudoku.constants.Rows;
...
import static projetosudoku.domain.SudokuGame.GRID_BOUNDARY;
...
public class GameLogic {
    ...
    private static boolean squareIsInvalid(int xIndex, int yIndex, int[][] grid){
        ...
        while (yIndex < yIndexEnd){
            while (xIndex < xIndexEnd){square.add(grid[yIndex][xIndex]);
                xIndex++;
            }
            xIndex-=3;
            yIndex++;
